    ...
    <section id="contact" className="section">
      ...
      >
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch] section-heading">
            <TextSplitter text="Contact me for collaboration" />
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] subheading">
